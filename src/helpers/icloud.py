            ...
            try:
                if album in self.api.photos.albums:
                    ...
                    for photo in self.api.photos.albums[album]:
                        ...
                        #TODO: Cleanup file-downloaded-with-nonid-name and duplicate file actions
                        ...
                        if paths.filename_with_id(photo) in files_on_disk:
                             # for later: this crashes if download-size medium is specified
        ...
        if self.is_authed:
            ...
            for photo in photos:
                try:
                    ...
                    self.app.flask_app.logger.error(e)
                    download_failures += 1
